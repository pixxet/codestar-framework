...
class CSFramework_Option_Image extends CSFramework_Options {
  ...
  public function output(){
    ...
    echo '<div class="cs-image-preview'. $hidden .'"><div class="cs-preview"><i class="'. CS_ICONS_PREFIX .' '. CS_ICONS_PREFIX. '-times cs-remove"></i><img src="'. $preview .'" alt="preview" /></div></div>';
